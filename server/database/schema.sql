...
CREATE TABLE IF NOT EXISTS mandal_settings (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  name_mr TEXT NOT NULL DEFAULT 'श्री गणेश मित्र मंडळ',
  name_en TEXT NOT NULL DEFAULT 'Shree Ganesh Mitra Mandal',
  tagline_mr TEXT DEFAULT 'स्थापना: १९९२ | नोंदणी क्र. महा/पुणे/२२/१९९२',
  tagline_en TEXT DEFAULT 'Est: 1992 | Reg. No. MAH/PUNE/22/1992',
  address_mr TEXT DEFAULT '१२४, कसबा पेठ, शनिवार वाडा जवळ, पुणे - ४११ ०११',
  address_en TEXT DEFAULT '124, Kasba Peth, Near Shaniwar Wada, Pune - 411011',
  contact_phone TEXT DEFAULT '+91 98220 12345',
  contact_email TEXT DEFAULT 'contact@ganeshmandal.org',
  registration_no TEXT DEFAULT 'MAH/PUNE/1992/F-1024',
  festival_year INTEGER DEFAULT 2026,
  arrival_date TEXT DEFAULT '2026-09-15T09:00:00',
  visarjan_date TEXT DEFAULT '2026-09-25T18:00:00',
  upi_id TEXT DEFAULT 'ganeshmandal@sbi',
  upi_name TEXT DEFAULT 'Shree Ganesh Mitra Mandal Trust',
  receipt_prefix TEXT DEFAULT 'GM-2026-',
